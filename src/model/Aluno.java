...
public class Aluno{
   ...
   public Aluno(int Codigo, String nome, String nexo, String dataNascimento, String endereco, int numero, String complemento,
   ...
   public void incluir() {
	...
	public void consultar() {
		...
		to.getNome(nome);
      to.getSexo(sexo);
      to.getDataNascimento(dataNascimento);
      to.getEndereco(endereco);
      to.getNumero(numero);
      to.getComplemento(complemento);
		to.getFone(fone);
      to.getRg(rg);
      to.getCPF(cpf);
      to.getEmail(email);
